...
class Quote(models.Model):
    ...
    composer_state = models.JSONField(
        blank=True,
        null=True,
        verbose_name=_("Composer State Snapshot"),
        help_text=_("Reconstructible composer selection (project, surfaces, services, client) — lets a client reopen this exact project in the composer from the public dossier link."),
    )
